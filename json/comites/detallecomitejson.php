...
$columns = array(
		...
		array( 'db' => 'o.obc_clave_int',  'dt' => 'clave',  'field' => 'obc_clave_int' ),
		array( 'db' => 'o.com_clave_int',  'dt' => 'comite',  'field' => 'com_clave_int' ),
        ...
        array( 'db' => 'o.obc_clave_int', 'dt' => 'eliminar', 'field' => 'obc_clave_int','formatter'=>function($d,$row){
			$ped = $row[2];
				return "<a class='btn btn-circle btn-block btn-danger btn-xs' onclick=CRUDCOMITES('ELIMINARDESARROLLO','".$d."') title='Eliminar Desarrollo' style='heigth:22px; width:22px'><i class='fa fa-trash'></i></a>";

		}),   
		array( 'db' => 'o.obc_clave_int', 'dt' => 'editar', 'field' => 'obc_clave_int','formatter'=>function($d,$row){
			$ped = $row[2];
			return "<a id='edit'  class='btn btn-block btn-warning btn-xs'  title='Editar Comité' style='heigth:22px; width:22px' ><i class='fa fa-edit'></i></a>";
